 ...
 * @property integer $intend_store_front_img
 * @property integer $store_front_img
 * @property string $arrival_time
 * @property string $leave_time
 * @property string $arrival_distance
 * @property string $leave_distance
...
class VisitRecords extends ActiveRecord
{
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if($insert && $this->customer_id > 0){
            ...
            }elseif ($this->is_intended == 1){
                $customer = LeCustomersIntention::findOne(['entity_id' => $this->customer_id]);
            }
            if($customer){
