...
use service\message\sales\FirstOrderCustomerCount;
use framework\db\readonly\models\core\SalesFlatOrder;

class firstOrderCustomer extends TaskAbstract
{
    ...
    private function getFirstOrderCustomerCount($start_date,$end_date = null){
        ...
        $this->log($query->createCommand()->getRawSql(),'firstOrderCustomerCount.sql.log');
